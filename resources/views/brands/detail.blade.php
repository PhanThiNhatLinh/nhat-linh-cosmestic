            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">
                    ...
                    {{-- <div class="filter-widget">
                        ...
                        @foreach ($brand->typeproduct as $type )
                        <ul class="filter-catagories">
                            <li><a href="#">{{$type->product_type_name}}</a>
                    </li>
                ...
                {{-- <div class="filter-widget">
                    ...
                    @foreach ($typeproduct->product as $product )
                    <div class="fw-brand-check">
                        <div class="bc-item">
                            <label for="bc-calvin">
                                {{$product->brand->brand_name}}
                <input type="checkbox" id="{{$product->brand->brand_id}}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="data:image/jpg;base64, {{$product->image}}" style="width:300px; height:300px"
                                    alt="">
                                <span>@if($product->promotion !== 0)
                                ...
                                <ul>
                                    ...
                                    <form action="{{ route('cart.add') }}" method="post">
                                        ...
                                        <input type="hidden" name="productId" value="{{$product->STT}}">
                                        <li class="w-icon active"><button type="submit"
                                                class="btn btn-success btn-lg"><i class="icon_bag_alt"></i></button>
                                        </li>
                                    </form>
                                    @else
                            ...
                            <a href="{{ route('showdetail', ['id' => $product->STT ]) }}">
                                <h5>
                            ...
                            <div class="product-price">
                                {{$product->price}}VND
                                <span>@if($product->promotion !== 0)
                                    {{number_format($product->promotion)}}VND
                                    @endif</span>
                            </div>
                        </div>
                    </div>
