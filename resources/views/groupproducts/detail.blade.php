...
<body>
    ...
    <div class="container">
        <h2 class="text-center">{{ $groupproduct->group_name }}</h2>
        <p>{{$groupproduct->description}}</p>
        {{-- <ul>
            @foreach ($groupproduct->products as $product )
            <p><a href="{{ route('showdetail', ['id' => $product->STT ]) }}">{{$product->product_name}}</a></p>
        @endforeach
        </ul> --}}
    </div>
                                    ...
                                    <div class="pi-pic">
                                        ...
                                        <ul>
                                            ...
                                            <li class="quick-view"><a
                                                    href="{{ route('showdetail', ['id' => $product->STT ]) }}">Chi
                                                    Tiết</a></li>
                                        </ul>
                                    </div>
                                    <div class="pi-text">
                                        <div class="catagory-name">{{$product->typeproduct->product_type_name}}</div>
